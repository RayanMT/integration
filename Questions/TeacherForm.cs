...
namespace PROJECT
{
    public partial class TeacherForm : Form
    {
        ...
        {
            // Assume there's a form to create exams
            // CreateExamForm form = new CreateExamForm();
            // form.Show(); // Or use ShowDialog if you want it to block the previous window
            MessageBox.Show("Here you can create an exam from the question bank.", "Create Exam", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
